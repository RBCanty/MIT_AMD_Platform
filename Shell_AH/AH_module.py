...
try:
    ...
    from Evoware_API.cleanup_characterization_plate import cleanup_characterization_plate
...
def get_functions():
    ...
    function_list = {
        ...
        'cleanup_characterization_plate': evoware_method_selector,
...
def evoware_thread_func(name, document_queue_name, operation_number, evoware_method_name, evoware_queue):
    ...
    elif evoware_method_name == 'cleanup_characterization_plate':
        method_return = cleanup_characterization_plate(document_queue_name, operation_number)
