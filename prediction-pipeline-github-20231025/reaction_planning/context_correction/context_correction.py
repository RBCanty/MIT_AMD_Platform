...
# rxn_rules = see: "Context correction details.pdf"
# rxn_class = see above
...
def predict_rxn_class(rxn_smiles: str):
    ...
    """
    hostname = r'ASKCOS url and port #'
...
def check_context(context: dict, rxn_class: str, rxn_smiles: str):
    ...
    augmented_context : dict
        a dictionary with all the info for an augmented context, see: "Context correction details.pdf"
